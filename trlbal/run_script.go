...
func RunScript(script string) string {
	...
	fmt.Printf("/home/brent/src/repsys/volumes/go/runner/main\n")
	...
	cmd6 := exec.Command("/home/brent/src/repsys/volumes/go/runner/main/test.sh", "dev", "reports11", "30011", "1", "reports11", "30311", "reports")
